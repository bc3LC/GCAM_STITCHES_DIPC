...
# COMMON PATHS 
# IF_PATH = "C:\\Users\\claudia.rodes\\Documents\\Heat\\GCAM_STITCHES_DIPC" # to run locally the If_job_script_generation.py
IF_PATH = "/scratch/bc3lc/heat-deaths/GCAM_STITCHES_DIPC"                   # to run on DIPC server any other script

# HPC CONDA ENVIRONMENT
conda_env = "heat2"

# EXPERIMENT NAME 
experiment_name = "heat_29012026"
