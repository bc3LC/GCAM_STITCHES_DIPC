...
def sd_stitches(run_object, run_name):
    ...
    with open(os.path.join(run_object.Output_Location, f"ds_data_{run_object.ESM}_{run_object.Variable}_{run_object.Scenario}.pkl"), 'wb') as f:
        pickle.dump(ds, f)
    print("SD Initialization Saved")
